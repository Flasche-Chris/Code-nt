...
def print_introduction():
    print("Hey, willkommen bei Code'nt!\n\nBei Code'nt geht es darum schnell und genau zu sein!\n"
          "Dir wird am Bildschirm ein Numerischercode angezeigt, diesen musst du innerhalb der vorgegeben Zeit eingeben"
          " und mit Enter bestätigen. Das war's!\nLänge des Codes, sowie die Zeit und die Punkte die du bekommst"
          " unterscheiden sich vom ausgewählten Schwierigkeitsgrad her!\nDas Spiel endet sofort, wenn der Code nicht"
          " korrekt oder die Zeit abgelaufen ist.\n Kleiner Tipp, am besten spielt sich Code'nt mit einem Numpad)"
